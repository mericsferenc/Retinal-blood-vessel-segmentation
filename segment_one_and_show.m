...
figure;
subplot(2,4,1), imshow(inputImage), title('Original');
subplot(2,4,2), imshow(I_denoised), title('Green channel');
subplot(2,4,3), imshow(I_enhanced), title('Enhanced');
subplot(2,4,4), imshow(I_edge), title('LoG Filter');
subplot(2,4,5), imshow(I_sharpened), title('Sharpened');
subplot(2,4,6), imshow(I_binarized), title('Binarized');
subplot(2,4,7), imshow(I_opened), title('Denoised');
